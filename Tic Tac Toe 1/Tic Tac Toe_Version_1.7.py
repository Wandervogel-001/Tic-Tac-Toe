# Tic-Tac-Toe Game Version (1.7): The AI Update! What's new ? :
# Added diffuculities: [No Difficulty], [Easy], [Normal].
# modified the functions for the computer's moves, including difficulty [Hard].
# fixed other code bugs, renamed functions, cleared unnessecary code, added time delay for user experience.
# added board display for user experience

...
# The Game takes on a new journey of a transformation, from the old console game, to a new game that implents graphical user interference
# This version, like the old tic tac toe, starts with a basic and a simple tic tac toe, play against your friend :3
...
def draw_outro():
    ...
    message_rect = message_surface_scaled.get_rect(center =(225, 250))
    screen.blit(message_surface_scaled, message_rect)

    instruction_message = game_font.render('Press Space to retry', False, 'Black')
    instruction_message_rect = instruction_message.get_rect(center = (225, 450))

...
def print_menu():
    ...
    if mode == 2:
        if menu == 3:
            ...
            screen.blit(x_surf_scaled, x_rect)
            screen.blit(o_surf_scaled, o_rect)
    elif mode == 3:
        if menu == 3:
...
def print_winner():
    global mode, player_symbol, computer_symbol
    print_board()
    winner = check_winner(board)
    if mode == 1:
        if winner == 'X':
            message = winner_messages_mode_1[0]
        elif winner == 'O':
            message = winner_messages_mode_1[1]
        else:
            message = winner_messages_mode_1[2]
    elif mode == 2:
        if winner == player_symbol:
            message = winner_messages_mode_2[0]
        elif winner == computer_symbol:
            message = winner_messages_mode_2[1]
        else:
            message = winner_messages_mode_2[2]
    else:
        if winner == 'X':
            message = winner_messages_mode_3[0]
        elif winner == 'O':
            message = winner_messages_mode_3[1]
        else:
            message = winner_messages_mode_3[2]
    ...
    instruction_message_rect = instruction_message.get_rect(center = (screen_x_centre, screen_y_centre + 225))
...
winner_messages_mode_1 = ['Player X wins', 'Player O wins', "It's a Tie"]
winner_messages_mode_2 = ['You Won!', 'You Lost!', "It's a Tie"]
winner_messages_mode_3 = ['Computer X wins', 'Computer O wins', "It's a Tie"]
...
# symbols_surf_scaled = pygame.transform.scale2x(symbols_surf)
x_surf = game_font.render('X', False, 'Black')
x_surf_scaled = pygame.transform.scale(x_surf, (20, 20))
o_surf = game_font.render('O', False, 'Black')
o_surf_scaled = pygame.transform.scale(o_surf, (20, 20))

symbols_rect = symbols_surf.get_rect(center = (screen_x_centre, mode_y_pos))
x_rect = x_surf_scaled.get_rect(center = (screen_x_centre - 50, mode_y_pos + 50))
o_rect = o_surf_scaled.get_rect(center = (screen_x_centre + 50, mode_y_pos + 50))

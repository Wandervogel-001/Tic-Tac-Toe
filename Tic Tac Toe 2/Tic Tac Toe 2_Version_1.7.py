# Tic-Tac-Toe 2!
# Game Version: 1.7
# The Game Simulator Update! What's new ?:
# added mode 3: simulate a game
# modified the code to adapt to any screen width and height
...
def print_winner():
    ...
    message_rect = message_surface_scaled.get_rect(center =(screen_x_centre, screen_y_pos - 70))
    ...
    instruction_message_rect = instruction_message.get_rect(center = (screen_x_centre, screen_y_pos - 25))
